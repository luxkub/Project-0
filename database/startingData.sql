...
VALUES ('God of War; Ragnarok', 'Kratos and Atreus must journey to each of the Nine Realms in search of answers against Asgardian forces.', 60.00, 100, 'static\images\God_of_War_Ragnarök_cover.jpg', 'Videogame');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Divinity Original Sin 2', 'The Divine is dead. The Void approaches. And the powers lying dormant within you are soon to awaken. ', 40.00, 50, 'static\images\Divinity-Original-Sin-II-Cover-Art-001.jpg', 'Videogame');
...
INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Minecraft', 'Experience Minecraft in a whole new light—or dark. The choices are endless, and all of them yours.', 26.00, 100, 'static\images\Minecraft_game_cover.jpeg', 'Videogame');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Prey', 'Prey is a first-person shooter with role-playing and stealth elements set in an open world environment.', 30.00, 75, 'static\images\Prey_cover_art.jpg', 'Videogame');
...
INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Red Dead Redemption 2', 'The epic story of outlaw Arthur Morgan and the notorious Van der Linde gang.', 59.99, 30, 'static\images\RDR2.jpg', 'Videogame');
